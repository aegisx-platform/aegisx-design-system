...
(function(){
  ...
  AX6.register(function ioSection(){
    ...
    card.innerHTML = [
      ...
      '    <span class="io__shift-status">complete</span>',
      '  </div>',
      ...
      '      <tr class="io__subtotal-row"><td class="io__td" colspan="4" class="io__td io__td--bal-label">Shift balance</td><td class="io__td io__td--vol io__bal--pos">+970</td></tr>',
      '    </tbody>',
      '  </table>',
      '</div>',
      ...
      '      <tr class="io__subtotal-row"><td class="io__td" colspan="4" class="io__td io__td--bal-label">Shift balance</td><td class="io__td io__td--vol io__bal--pos">+250</td></tr>',
      '    </tbody>',
      '  </table>',
      '</div>',
      ...
      '    <span>Night shift &nbsp;<small>23:00–07:00</small> <span class="io__in-progress-badge">in progress</span></span>',
      '    <span class="io__shift-status">as of 02:00</span>',
      '  </div>',
      '  <table class="io__table">',
      '    <tbody>',
      ...
      '      <tr class="io__subtotal-row"><td class="io__td" colspan="4" class="io__td io__td--bal-label">Shift balance</td><td class="io__td io__td--vol io__bal--pos">+310</td></tr>',
      '    </tbody>',
      '  </table>',
      '</div>',
